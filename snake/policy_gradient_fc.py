...
def train(n_batch, n_iterations, learning_rate = 0.001):
    ...
    with tf.Session() as sess:
        ...
        # save model
        print('Saving model to models/weights_fc.p')
        pkl.dump((w1.eval(), b1.eval(), w2.eval(), b2.eval()), open('models/weights_fc.p','w'))
...
def test(weights_path):
    ...
    # asssign weights
    print('Loading model')
    weights = pkl.load(open('models/weights_fc.p', 'rb'))
